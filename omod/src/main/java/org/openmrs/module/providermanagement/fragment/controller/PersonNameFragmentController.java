...
public class PersonNameFragmentController {
	...
	{
		 try {
				// load the NameSupport with the openmrsClass loader from the fully qualified
				// class name
			// from the api layer of openmrs.
				...
				// invoke the getInstance method of the NameSupport class being
				// loaded at runtime
				...
				// invoke the getDefaultLayoutTemplate method of the NameSupport class being
				// loaded at runtime
